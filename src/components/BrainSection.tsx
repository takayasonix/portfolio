      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
          ...
          <div className="flex items-stretch justify-center">
            <div className="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl shadow-[8px_8px_16px_rgba(0,0,0,0.1),-8px_-8px_16px_rgba(255,255,255,0.8)] hover:shadow-[12px_12px_24px_rgba(0,0,0,0.15),-12px_-12px_24px_rgba(255,255,255,0.9)] overflow-hidden transition-all duration-300">
              {/* 画像 */}
          ...
          {/* 右側：草の表示カード */}
          <div className="flex items-stretch justify-center">
            <div className="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-4 md:p-6 shadow-[8px_8px_16px_rgba(0,0,0,0.1),-8px_-8px_16px_rgba(255,255,255,0.8)] hover:shadow-[12px_12px_24px_rgba(0,0,0,0.15),-12px_-12px_24px_rgba(255,255,255,0.9)] transition-all duration-300">
              {/* 見出し */}
